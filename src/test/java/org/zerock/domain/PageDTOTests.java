...
public class PageDTOTests {
	...
	public void test() {
		...
		assertEquals(10, new PageDTO(new Criteria(10, 10)).getEndPage());
		assertEquals(10, new PageDTO(new Criteria(11, 10)).getEndPage());
		assertEquals(10, new PageDTO(new Criteria(12, 10)).getEndPage());
		assertEquals(10, new PageDTO(new Criteria(13, 10)).getEndPage());
		assertEquals(10, new PageDTO(new Criteria(14, 10)).getEndPage());
		assertEquals(10, new PageDTO(new Criteria(15, 10)).getEndPage());
		assertEquals(10, new PageDTO(new Criteria(16, 10)).getEndPage());
		assertEquals(10, new PageDTO(new Criteria(17, 10)).getEndPage());
		assertEquals(10, new PageDTO(new Criteria(18, 10)).getEndPage());
		assertEquals(10, new PageDTO(new Criteria(19, 10)).getEndPage());
		assertEquals(10, new PageDTO(new Criteria(20, 10)).getEndPage());
	}
